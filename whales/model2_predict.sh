...
PARAMS=models/model2_params.3c

PCA_DATA=models/model2_pca
MEAN_DATA=models/model2_mean

SAMPLE_SUB=data/sample_submission.csv

NAME=model2_predict
EXP_DIR=model2_predict
...
--equalize --name ${NAME} --margin 40 --arch new_gsc3 --global-saver-url global \
--aug-params magik_z --indygo-equalize --glr-burnout 15 --valid-partial-batches --train-part 1.0 \
--train-pool-size 5 \
--load-params-url ${PARAMS} \
--pca-data-url ${PCA_DATA} \
--mean-data-url ${MEAN_DATA} \
