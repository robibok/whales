...
PARAMS=models/model3_params.3c

PCA_DATA=models/model3_pca
MEAN_DATA=models/model3_mean

SAMPLE_SUB=data/sample_submission.csv

NAME=model3_predict
EXP_DIR=model3_predict
...
--train-pool-size 1 --test-pool-size 1 --train-part 1.0 --global-saver-url global \
