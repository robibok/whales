...
# replace path if you want to use the output of head_localizer_predict script
AUTO_SLOT=data/all_bbox.json

SAMPLE_SUB=data/sample_submission.csv

NAME=ha_predict_train
EXP_DIR=ha_predict_train
...
--gen-crop2-train --no-train --test-csv-url ${SAMPLE_SUB} --test-dir-url ${IMG_DIR}