...
NAME=net2_predict
EXP_DIR=net2_predict

PARAMS=net2_fit_step2/training/epoch_100.3c
...
--loss-freq 5 --do-pca 1 --pca-scale 0.01 --fc-l2-reg 0.05 --conv-l2-reg 0.0005 --do-mean 1 --glr-decay 0.9955 \
...
--train-pool-size 5 --exp-dir-url ${EXP_DIR} --target-name final --mode final --train-part 1.0 --n-epochs 100 \
